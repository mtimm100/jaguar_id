...
function sim = sift_mosaic(im1, im2, display, firstJag, secondJag, matchNum) %rewritten by mikayla
...
% --------------------------------------------------------------------
    ...
    %str = sprintf('results/sift_lines/Jaguar_%s_match_%d.jpg', firstJag, matchNum);
    %saveas(gcf,str);
